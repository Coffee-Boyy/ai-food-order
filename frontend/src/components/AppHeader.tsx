    ...
    <header className="sticky top-0 z-99999 w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:border-b-0 lg:px-0 lg:py-4">
          <button
            type="button"
            className="z-99999 flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 dark:border-gray-800 dark:text-gray-400 lg:flex lg:h-11 lg:w-11"
          ...
          <Link to="/" className="flex items-center gap-2 lg:hidden">
            ...
            <span className="font-semibold text-gray-900 dark:text-white">Food Order</span>
          </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden min-w-0 items-center gap-2 sm:flex">
              <div className="hidden h-10 w-10 shrink-0 overflow-hidden rounded-full border border-gray-200 dark:border-gray-700 lg:flex">
                {user?.pictureUrl ? (
